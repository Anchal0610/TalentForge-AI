        ...
        <Card className="bg-surface border-border p-8 text-center max-w-xl mx-auto space-y-6 mt-10 shadow-lg">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted leading-relaxed">
              Nexora AI needs your target role and skills to compile custom interview guides. Please upload your resume in the Document Hub to start generating your interview preparation.
            </p>
          </div>
